...
#if defined(INCLUDE_DSL_CPE_API_VRX)
   DSL_G997_AttainableNdrStatus_t   attndrStatus;
...
/**
   Magic number (r: 0x72) for common DSL CPE_API ioctls. */
#define DSL_IOC_MAGIC_CPE_API          'r'

/**
   Magic number (g: 0x67) for G.997.1 related DSL CPE_API ioctls. */
#define DSL_IOC_MAGIC_CPE_API_G997     'g'

/**
   Magic number (p: 0x70) for Performance Monitoring related DSL CPE_API
   ioctls. */
#define DSL_IOC_MAGIC_CPE_API_PM       'p'

/**
   Magic number (b: 0x62) for bonding (PAF - PMA Aggregation Function) related
   DSL CPE_API ioctls.
...
/**
   Magic number (b: 0x64) for deprecated ioctl's of the DSL CPE_API.
   \note This ioctl's will be removed on mid term. */
#define DSL_IOC_MAGIC_CPE_API_DEP      'd'

/**
   Magic number (b: 0x6D) for MIB related ioctls of DSL CPE_API.
   \note This part is only available for ADSL only capable platforms. */
#define DSL_IOC_MAGIC_MIB              'm'

/**
   Magic number (b: 0x74) for Real Time Trace related DSL CPE_API ioctls.
...
/**
   This function returns the ADSL xTU-O's T1.413 revision number.

   CLI
   - long command: T1413_XTUO_RevisionGet
   - short command: t1413xtuorg

   \param DSL_T1413RevisionStatus_t*
   ...
   \code
      DSL_T1413RevisionStatusData_t t1413RevisionStatus;
      DSL_int_t ret = 0;

      memset(&t1413RevisionStatus, 0x00, sizeof(DSL_T1413RevisionStatus_t));
      ret = ioctl(fd, DSL_FIO_T1413_XTUO_REVISION_GET, &t1413RevisionStatus); //
      Process returned values after ioctl call here ...
   \endcode

   \ingroup DRV_DSL_CPE_COMMON */
#define DSL_FIO_T1413_XTUO_REVISION_GET \
   _IOWR(DSL_IOC_MAGIC_CPE_API, 66, DSL_T1413RevisionStatus_t)

/**
   This function returns the ADSL xTU-R's T1.413 revision number.

   CLI
   - long command: T1413_XTUR_RevisionGet
   - short command: t1413xturrg

   \param DSL_T1413RevisionStatusData_t*
   The parameter points to a \ref DSL_T1413RevisionStatus_t structure
   ...
   \code
      DSL_T1413RevisionStatus_t t1413RevisionStatus;
      DSL_int_t ret = 0;

      memset(&t1413RevisionStatus, 0x00, sizeof(DSL_T1413RevisionStatus_t));
      ret = ioctl(fd, DSL_FIO_T1413_XTUR_REVISION_GET, &t1413RevisionStatus);
      // Process returned values after ioctl call here ...
   \endcode

   \ingroup DRV_DSL_CPE_COMMON */
#define DSL_FIO_T1413_XTUR_REVISION_GET \
   _IOWR(DSL_IOC_MAGIC_CPE_API, 67, DSL_T1413RevisionStatus_t)

/**
   This function returns the ADSL xTU-O's T1.413 Vendor revision number.

   CLI
   - long command: T1413_XTUO_VendorRevisionGet
   - short command: t1413xtuovrg

   \param DSL_T1413VendorRevisionStatus_t*
   ...
   \code
      DSL_T1413VendorRevisionStatusData_t t1413VendorRevisionStatus;
      DSL_int_t ret = 0;

      memset(&t1413VendorRevisionStatus, 0x00, sizeof(DSL_T1413VendorRevisionStatus_t));
      ret = ioctl(fd, DSL_FIO_T1413_XTUO_VENDOR_REVISION_GET, &t1413VendorRevisionStatus); //
      Process returned values after ioctl call here ...
   \endcode

   \ingroup DRV_DSL_CPE_COMMON */
#define DSL_FIO_T1413_XTUO_VENDOR_REVISION_GET \
   _IOWR(DSL_IOC_MAGIC_CPE_API, 68, DSL_T1413VendorRevisionStatus_t)

/**
   This function returns the ADSL xTU-R's T1.413 Vendor revision number.
   ...
   \code
      ...
      memset(&t1413VendorRevisionStatus, 0x00, sizeof(DSL_T1413VendorRevisionStatus_t));
      ret = ioctl(fd, DSL_FIO_T1413_XTUR_VENDOR_REVISION_GET, &t1413VendorRevisionStatus); //
      Process returned values after ioctl call here ...
   \endcode

   \ingroup DRV_DSL_CPE_COMMON */
#define DSL_FIO_T1413_XTUR_VENDOR_REVISION_GET \
   _IOWR(DSL_IOC_MAGIC_CPE_API, 69, DSL_T1413VendorRevisionStatus_t)

/**
   This ioctl makes it possible to control the PSD calibration.

   CLI
   - long command: PsdCalibrationConfigGet
   - short command: pccg

   \param DSL_PSDCalibration_t*
   ...
   \ingroup DRV_DSL_CPE_COMMON */
#define DSL_FIO_PSD_CALIBRATION_CONFIG_GET \
   _IOWR(DSL_IOC_MAGIC_CPE_API, 70, DSL_PSDCalibration_t)

/**
   This ioctl makes it possible to control the PSD calibration.

   CLI
   - long command: PsdCalibrationConfigSet
   - short command: pccs
...
#define DSL_FIO_G997_BIT_ALLOCATION_NSC_GET \
   _IO(DSL_IOC_MAGIC_CPE_API_G997, 15)
...
#define DSL_FIO_G997_SNR_ALLOCATION_NSC_GET \
   _IO(DSL_IOC_MAGIC_CPE_API_G997, 17)
...
#define DSL_FIO_G997_DELT_SNR_GET \
   _IO(DSL_IOC_MAGIC_CPE_API_G997, 30)
...
#define DSL_FIO_G997_DELT_QLN_GET \
   _IO(DSL_IOC_MAGIC_CPE_API_G997, 31)
...
/**
   This function reads the attainable net data rate status.

   CLI
   - long command: G997_AttainableNdrStatusGet
   - short command: g997ansg

   \param DSL_G997_AttainableNdrStatus_t*
   ...
   \code
      DSL_G997_AttainableNdrStatus_t attndrStGet;
      DSL_int_t ret = 0;

      memset(&attndrStGet, 0, sizeof(DSL_G997_AttainableNdrStatus_t));
      ret = ioctl(fd, DSL_FIO_G997_ATTAINABLE_NDR_STATUS_GET, &attndrStGet);
      // attndrStGet includes the attainable ndr status
   \endcode

   \ingroup DRV_DSL_CPE_G997 */
#define DSL_FIO_G997_ATTAINABLE_NDR_STATUS_GET \
   _IOWR(DSL_IOC_MAGIC_CPE_API_G997, 41, DSL_G997_AttainableNdrStatus_t)
#endif /* INCLUDE_DSL_CPE_API_VRX*/
